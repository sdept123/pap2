          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="chartjs.php">
                ...
                <span class="menu-title">Clube</span>
              </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#jogadores" aria-expanded="false" aria-controls="jogadores">
                <i class="menu-icon typcn typcn-coffee"></i>
                <span class="menu-title">Jogadores</span>
                <i class="menu-arrow"></i>
              </a>
              <div class="collapse" id="jogadores">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="pages/ui-features/buttons.html">Jogadores</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/ui-features/dropdowns.html">Estatisticas</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/ui-features/typography.html">Posição</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/ui-features/typography.html">Escalões</a>
                  </li>
                </ul>
              </div>
            </li>        
            <li class="nav-item">
              <a class="nav-link" data-toggle="collapse" href="#treinador" aria-expanded="false" aria-controls="treinador">
                <i class="menu-icon typcn typcn-coffee"></i>
                <span class="menu-title">Treinadores</span>
                <i class="menu-arrow"></i>
              </a>
              <div class="collapse" id="treinador">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="pages/ui-features/buttons.html">Treinadores</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/ui-features/dropdowns.html">Função</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" href="pages/ui-features/typography.html">Escalões</a>
                  </li>
