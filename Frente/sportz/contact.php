          ...
          <ul class="site-menu js-clone-nav d-none d-md-block">
            ...
            <li class="has-children">
                ...
                <ul class="dropdown arrow-top">
                  <li><a href="team1.html">EQUIPA PRINCIPAL</a></li>
                  <li><a href="team2.html">JUNIORES</a></li>
                  <li><a href="team3.html">JUVENIS</a></li>
                  <li><a href="team4.html">INICIADOS</a></li>
                </ul>            
            </li>        
            <li><a href="noticias.html">Noticias</a></li>
            <li><a href="contact.html">Clube</a></li>   
            <li class="has-children">
              <a href="#">Perfil</a>
              <ul class="dropdown arrow-top">
      ...
      <div class="container">
        <div class="row align-items-center justify-content-start">
          <div class="col-md-6 text-center text-md-left" data-aos="fade-up" data-aos-delay="400">
            <h1 class="bg-text-line">Clube</h1>
